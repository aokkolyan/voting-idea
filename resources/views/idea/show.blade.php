<x-app-layout>
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex flex-col md:flex-row items-center space-x-4 md:ml-6">
            <div x-data="{ isOpen: false }" class="relative">
                ...
                <div x-cloak x-show.transition.origin.top.left.duration.700ms="isOpen" @click.away="isOpen = false"
                    @keydown.escape.widnow = "isOpen = false"
                    class="absolute z-10 w-68 md:w-104 text-left font-semibold text-sm bg-white shadow-dailog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            <button type="button"
                                class="flex items-center justify-center  w-full h-11 md:w-1/2 text-sm bg-blue text-white border border-blue 
                                 hover:bg-blue-hover font-bold rounded-xl px-2 py-1">
                                Post comment
                            </button>
                            <button type="button"
                                class="flex items-center  justify-center w-full md:w-32 h-11 bg-gray-200 hover:bg-gray-200 text-xs font-bold rounded-xl px-2 py-2 mt-2 md:mt-0">
            ...
            <div x-data = "{isOpen:false}" class="relative">
                <button type="button" @click=" isOpen = !isOpen "
                    class="flex items-center justify-center w-32 h-11 bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold rounded-xl px-4 py-2 mt-2 md:mt-0 mr-5">
                    <span class="mr-1">
                        Set status</span>
                ...
                <div x-cloak x-show.transition.origin.top.left.duration.ease-in.500ms = "isOpen"
                    @click.away="isOpen = false"
                    class=" absolute z-20  md:w-76 text-left font-semibold text-sm bg-white shadow-dailog rounded-xl mt-2">
                    <form action="#" class=" space-y-4 px-4 py-6 cursor-pointer">
                        ...
                        <textarea name="update_comment" id="update_comment" rows="4"
                        ...
                        <div class="flex items-center mb-4">
                            <input name="notify_voters" id="notify_voters" type="checkbox" value=""
                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="default-checkbox"
                                class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Notify all
                                voters</label>
                        </div>
                    </form>
                </div>
    ...
    <div class="comments-container relative space-y-6 md:ml-22 my-8 pt-6 mt-1">
        <div class="comment-container  space-y-6 my-6  flex rounded-xl">
                            ...
                            <div class=" flex items-center space-x-2">
                                <button @click=" isOpen = !isOpen"
                                    ...
                                    <ul x-cloak x-show.transition.origin.top.left.duration.700ms="isOpen"
                                        ...
                                        class=" absolute w-44 text-left font-semibold bg-white shadow-dailog rounded-xl py-3 px-2 z-10 md:ml-8 top-8 md:top-6 right-0 md:left-0">
                                        <li><a href="#"
        ...
        <div class="comment-container  relative bg-white rounded-xl flex  box-shadow mt-3">
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="{{ asset('assets/avatar/avatar_147142.png') }}" alt="avatar"
                            class="w-14 h-14 rounded-xl ">
                    </a>
                </div>
                <div class="w-full md:mx-4">
        ...
        <div class="comment-container relative bg-white rounded-xl flex  box-shadow mt-3">
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="{{ asset('assets/avatar/avatar_147143.png') }}" alt="avatar"
                            class="w-14 h-14 rounded-xl ">
                    </a>
                </div>
                <div class="w-full md:mx-4">
        ...
        <div class="comment-container relative bg-white rounded-xl flex  box-shadow mt-3">
            <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                <div class="flex-none">
                    <a href="#">
                        <img src="{{ asset('assets/avatar/holland_190621.png') }}" alt="avatar"
                            class="w-14 h-14 rounded-xl ">
                    </a>
                </div>
                <div class="w-full md:mx-4">
